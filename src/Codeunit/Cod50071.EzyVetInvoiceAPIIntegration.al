codeunit 50071 "EzyVet Invoice API Integration"
{
    ...
    begin
        if not GuiAllowed then begin
            ...
            APIConfiguration.TestField(invoice_url);
            ...
            if APIConfiguration.invoice_url = '' then begin
                lErrorMsgonSetups := 'Invoice Endpoint Url is blank in API configuration Setup';
                exit;
            end;
    ...
    procedure GetInvoiceListPages(lAccessToken: text; RecordType: Option New,Modified; lDateFilters: Text; var lPagesCount: Integer; var lErrorMessage: text)
    var
        lhttpClient: HttpClient;
        lhttpContent: HttpContent;
        lhttpHeaders: HttpHeaders;
